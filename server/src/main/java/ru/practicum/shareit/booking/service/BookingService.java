...
public interface BookingService {
    ...
    List<BookingDto> getBookingsByState(Long userId, String state, int from, int size);

    List<BookingDto> getBookingByOwnerAndState(Long ownerId, String state, int from, int size);
